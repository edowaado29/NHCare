...
$obj = new Functions();
$selectDonasi = $obj->get_data("SELECT * FROM tb_donasi WHERE transaction_id = '$transaction_id'");
...
<div class="sidebar">
    ...
    <section class="home-section">
        ...
        <div class="home-body">
            <div class="back-btn">
                <button type="button" onclick="window.location.href='pemasukan.php'"  class="btn btn-danger">Kembali</button>
            </div>
            <div class="table"> 
                <div class="table-header">
                    <div class="table-section">
                        <table>
                            <caption>Data Donasi</caption>
                            <tbody>
                                <?php
                                while ($row = mysqli_fetch_assoc($selectDonasi)) :
                                ?>
                                    <tr>
                                        <th >Id Transaksi</th>
