...
$obj = new Functions();
$selectDonatur = $obj->get_data("SELECT * FROM tb_donatur");
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" onclick="window.location.href='detail_donatur.php?id_donatur=<?php echo $row['id_donatur']; ?>'"><i class='bx bx-show' ></i></button>
                                </td>
                            </tr>
                            <?php 
                            $no++;
