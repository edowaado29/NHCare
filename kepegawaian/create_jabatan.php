...
if(isset($_POST['simpan'])){
    ...
    if(empty($jabatan)){
        ...
        $insertJabatan = $obj->insert_data("INSERT INTO tb_jabatan_pegawai (nama_jabatan) VALUES ('$jabatan')");
        if($insertJabatan){
...
<body>
    ...
    <section class="home-section">
        <div class="home-content">
            ...
            <h3>Tambah Jabatan Pegawai</h3>
        </div>
            <div class= "home-body">
                <div class="card-body">
                    <form action="create_jabatan.php" method="POST" enctype="multipart/form-data">
                        <div>
