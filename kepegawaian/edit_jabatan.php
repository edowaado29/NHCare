...
$obj = new Functions();
$selectJabatan = $obj->get_data("SELECT * FROM tb_jabatan_pegawai WHERE id_jabatan = $id_jabatan");
$rowJabatan = mysqli_fetch_assoc($selectJabatan);
...
if(isset($_POST['simpan'])){
    ...
    if(empty($jabatan)){
        ...
        $updateJabatan = $obj->update_data("UPDATE tb_jabatan_pegawai SET nama_jabatan='$jabatan' WHERE id_jabatan=$id");
        if($updateJabatan){
            ...
            <div class= "home-body">
                <div class="card-body">
                    <form action="" method="POST">
                        <input type="hidden" name="id" value="<?php echo $_GET['id_jabatan']; ?>">
                        <div>
                            <label for="jabatan">Nama Jabatan</label>
                            <input type="text" id="jabatan" name="jabatan" value="<?php echo $rowJabatan['nama_jabatan']; ?>">
                        </div>
                        <div class="btn-container">
                            <button type="button" onclick="window.location.href='jabatan.php'" class="btn btn-danger">Kembali</button>
