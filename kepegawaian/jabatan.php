...
if (isset($_POST['hapus'])) {
    $id_jabatan = $_POST['hapus'];
    $result = $obj->delete_data("DELETE FROM tb_jabatan_pegawai WHERE id_jabatan = '$id_jabatan'");
    if ($result) {
            ...
            <div class="table">
                <div class="table-header">
                    ...
                    <div>
                        ...
                        <button type="button" onclick="window.location.href='create_jabatan.php'" class="add-new"><i class='bx bx-plus'></i> Tambah Data</button>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="" method="POST">
                                        <button type="button" onclick="window.location.href='detail_jabatan.php?id_jabatan=<?php echo $row['id_jabatan']; ?>'"><i class='bx bxs-show'></i></button>
                                        <button type="button" onclick="window.location.href='edit_jabatan.php?id_jabatan=<?php echo $row['id_jabatan']; ?>'"><i class='bx bxs-edit'></i></button>
                                        <button type="submit" name="hapus" value="<?php echo $row['id_jabatan']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus jabatan ini?');"><i class='bx bxs-trash'></i>
                                    </form>
                                </td>
                            </tr>
                            <?php 
