...
$obj = new Functions();
$selectAcara = $obj->get_data("SELECT * FROM tb_acara");

if (isset($_POST['hapus'])) {
    $id_acara = $_POST['hapus'];
    $result = $obj->delete_data("DELETE FROM tb_acara WHERE id_acara = '$id_acara'");
    if ($result) {
            ...
            <div class="table">
                <div class="table-header">
                    ...
                    <div>
                        ...
                        <button type="button" onclick="window.location.href='create_acara.php'" class="add-new"><i class='bx bx-plus'></i> Tambah Data</button>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="" method="POST">
                                        <button type="button" onclick="window.location.href='detail_acara.php?id_acara=<?php echo $row['id_acara']; ?>'"><i class='bx bxs-show'></i></button>
                                        <button type="button" onclick="window.location.href='edit_acara.php?id_acara=<?php echo $row['id_acara']; ?>'"><i class='bx bxs-edit'></i></button>
                                        <button type="submit" name="hapus" value="<?php echo $row['id_acara']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus acara ini?');"><i class='bx bxs-trash'></i>
                                    </form>
                                </td>
                            </tr>
                            <?php 
