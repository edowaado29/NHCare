...
if(isset($_POST['simpan'])){
    ...
    if(empty($judul) || empty($deskripsi) || empty($date)){
        ...
        header("Location: create_acara.php");
    } else {
        $insertAcara = $obj->insert_data("INSERT INTO tb_acara (judul, deskripsi, tanggal_acara, id_user) VALUES ('$judul', '$deskripsi', '$date', '$id_user')");
        if($insertAcara){
...
<body>
    ...
    <section class="home-section">
        <div class="home-content">
            ...
            <div class= "home-body">
                <div class="card-body">
                    <form action="create_acara.php" method="POST">
                        <div>
