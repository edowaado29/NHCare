...
$rowVideo = mysqli_fetch_assoc($selectVideo);

if(isset($_POST['simpan'])){
    $id = $_POST['id'];
    $judul_video = $_POST['name'];
    $url_video = $_POST['url'];

    if(empty($judul_video) || empty($url_video)){
        $_SESSION['empty_form'] = true;
    } else {
        $updateVideo = $obj->update_data("UPDATE tb_video SET judul_video='$judul_video', url_video='$url_video' WHERE id_video=$id");
        if($updateVideo){
            ...
            <div class= "home-body">
                <div class="card-body">
                    <form action="" method="POST">
                        <input type="hidden" name="id" value="<?php echo $_GET['id_video']; ?>">
                        <div>
                            <label for="name">Judul Video</label>
                            <input type="text" id="name" name="name" value="<?php echo $rowVideo['judul_video']; ?>">
                        </div>
                        <div>
                            <label for="url">URL Video</label>
                            <input type="text" id="url" name="url" value="<?php echo $rowVideo['url_video']; ?>">
                        </div>
